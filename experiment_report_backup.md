...
| CMAR12 | CMAR5 + imu=0.55 | 0.8837 | 0.8829 | 0.4605 | 0.4482 | 0.8163 | 0.7955 | 0.7202 | 0.4233 |
| CMAR13 | CMAR5 + imu=0.60 | 0.8744 | 0.8697 | 0.4628 | 0.4419 | 0.8256 | 0.8168 | 0.7209 | 0.4116 |
| CMAR14 | CMAR5 + rgbd=0.00 | 0.8860 | 0.8836 | 0.4000 | 0.3745 | 0.0372 | 0.0027 | 0.4411 | 0.8488 |
| CMAR15 | CMAR5 + cmar=0.2 | 0.8953 | 0.8932 | 0.4186 | 0.3998 | 0.7907 | 0.7691 | 0.7016 | 0.4767 |
| CMAR16 | imu=0.55, rgbd=0.03, cmar=0.15 | 0.8907 | 0.8888 | 0.4721 | 0.4531 | 0.8070 | 0.7977 | 0.7233 | 0.4186 |
| CMAR17 | freeze=none | 0.8047 | 0.8061 | — | — | — | — | — | — |
| CMAR18 | CMAR5 + seed=43 | 0.8721 | 0.8675 | 0.4581 | 0.4341 | 0.8047 | 0.7911 | 0.7116 | 0.4140 |
| CMAR19 | CMAR5 + cosine CMAR | 0.9023 | 0.9003 | 0.4209 | 0.4136 | 0.8186 | 0.8108 | 0.7140 | 0.4814 |
| CMAR20 | CMAR5 + independent dropout | 0.8860 | 0.8839 | 0.4000 | 0.3738 | 0.8395 | 0.8377 | 0.7085 | 0.4860 |
| CMAR21 | CMAR5 + aux=0.2 | 0.9000 | 0.8965 | 0.4442 | 0.4279 | 0.8116 | 0.8031 | 0.7186 | 0.4558 |
| CMAR22 | CMAR5 + d_model=256 | 0.9070 | 0.9064 | 0.4349 | 0.4017 | 0.7860 | 0.7725 | 0.7093 | 0.4721 |
| CMAR23 | CMAR5 + n_layers=3 | 0.8698 | 0.8641 | 0.3837 | 0.3689 | 0.8047 | 0.7814 | 0.6860 | 0.4860 |
| CMAR24 | imu=0.65, cmar=0.3 | 0.8977 | 0.8936 | 0.4605 | 0.4615 | 0.7256 | 0.6982 | 0.6946 | 0.4372 |
| CMAR25 | lr=1e-4, 150ep | 0.8628 | 0.8567 | 0.3535 | 0.3335 | 0.7558 | 0.7352 | 0.6574 | 0.5093 |
| CMAR26 | dropout=0.3 | 0.8791 | 0.8748 | 0.3116 | 0.2859 | 0.8209 | 0.8059 | 0.6705 | 0.5674 |

### 3.5 Extended Hyperparameter Sweep & Ablation (CMAR12–CMAR26)

Building on CMAR5 (best RGBD-only=0.4860), a systematic sweep explored hyperparameter variations, new loss types, and architectural changes. All experiments use the CMAR5 config as the baseline unless stated.

**CMAR5 base config**: d_model=160, cross_mamba, pretrained ResNet18, partial freeze, temporal_velocity=true, augment=true, bs=32, ls=0.1, mixup=0.15, wd=0.008, cosine_warmup(5), lr=3e-4, patience=40, seed=42, md_drop_imu=0.50, md_drop_rgbd=0.05, cmar_weight=0.1, cmar_proj_dim=64, aux_weight=0.1, cmar_loss_type=mse, md_drop_mode=exclusive.
...
| **CMAR18** | seed=43 | 0.8721 | 0.8675 | 0.4581 | 0.4341 | 0.8047 | 0.7911 | 0.7116 | Seed 42 is better |
...
| **CMAR21** | aux_weight=0.2 | 0.9000 | 0.8965 | 0.4442 | 0.4279 | 0.8116 | 0.8031 | 0.7186 | Marginal, higher aux doesn't help |
| **CMAR22** | d_model=256 | 0.9070 | 0.9064 | 0.4349 | 0.4017 | 0.7860 | 0.7725 | 0.7093 | ❌ Larger model no RGBD gain |
| **CMAR23** | n_layers=3 | 0.8698 | 0.8641 | 0.3837 | 0.3689 | 0.8047 | 0.7814 | 0.6860 | ❌ Overfits, hurts all |
| **CMAR24** | imu=0.65, cmar=0.3 | 0.8977 | 0.8936 | 0.4605 | 0.4615 | 0.7256 | 0.6982 | 0.6946 | ❌ Too aggressive, IMU collapses |
| **CMAR25** | lr=1e-4, 150ep, warmup=10, patience=60 | 0.8628 | 0.8567 | 0.3535 | 0.3335 | 0.7558 | 0.7352 | 0.6574 | ❌ Undertrained |
| **CMAR26** | dropout=0.3 | 0.8791 | 0.8748 | 0.3116 | 0.2859 | 0.8209 | 0.8059 | 0.6705 | ❌ Too much regularization |
...
2. **Cosine vs MSE CMAR** (CMAR19): Cosine slightly worse for RGBD-only despite decent Full accuracy
...
4. **Deeper model** (CMAR23, n_layers=3): Overfits severely on 431 samples
5. **Larger d_model** (CMAR22, d_model=256): Same Full accuracy but worse RGBD-only — more parameters don't help
...
8. **Higher classifier dropout** (CMAR26): Hurts RGBD-only badly — information bottleneck too tight
9. **CMAR5 config is a robust local optimum**: 15 experiments failed to beat its RGBD-only=0.4860

Key takeaways from the full CMAR sweep (CMAR1–CMAR26):
- **Best overall Full accuracy** remains **CMAR1**: 0.9093 / 0.9061.
- **Best RGBD-only** is **CMAR5**: 0.4860 / 0.4830, the strongest single-modality RGBD result.
...
- Larger `cmar_proj_dim`, larger `aux_weight`, deeper/wider architectures, and alternative loss types did not help.
...
| � | CMAR22 | 0.9070 | 0.9064 | 0.4349 | 0.7860 | 0.7093 |
| 4 | CMAR19 | 0.9023 | 0.9003 | 0.4209 | 0.8186 | 0.7140 |
| 5 | CMAR21 | 0.9000 | 0.8965 | 0.4442 | 0.8116 | 0.7186 |
| 6 | R4 (no robust) | 0.8977 | 0.8951 | 0.1419 | 0.7302 | 0.5900 |
| 6 | CMAR24 | 0.8977 | 0.8936 | 0.4605 | 0.7256 | 0.6946 |
| 8 | CMAR15 | 0.8953 | 0.8932 | 0.4186 | 0.7907 | 0.7016 |
| 8 | CMAR8 | 0.8953 | 0.8934 | 0.4186 | 0.8395 | 0.7178 |
| 10 | MD4 | 0.8930 | — | 0.3558 | **0.8767** | 0.7085 |

### 6.2 Best by RGBD-only Accuracy

| Rank | Exp | RGBD-only | Full | Avg | Note |
|------|-----|-----------|------|-----|------|
| 🥇 | **CMAR5** | **0.4860** | 0.9070 | 0.7287 | Best RGBD-only overall |
| 🥈 | CMAR16 | 0.4721 | 0.8907 | 0.7233 | imu=0.55, rgbd=0.03, cmar=0.15 |
| 🥉 | CMAR13 | 0.4628 | 0.8744 | 0.7209 | Higher IMU dropout=0.60 |
| 4 | CMAR12 | 0.4605 | 0.8837 | 0.7202 | imu=0.55 |
| 4 | CMAR24 | 0.4605 | 0.8977 | 0.6946 | imu=0.65, cmar=0.3 (IMU collapses) |
| 6 | CMAR18 | 0.4581 | 0.8721 | 0.7116 | Seed 43 variant |
| 7 | CMAR3 | 0.4512 | 0.8860 | **0.7341** | Best balanced robustness |
| 8 | CMAR21 | 0.4442 | 0.9000 | 0.7186 | aux=0.2 |
| 9 | CMAR22 | 0.4349 | 0.9070 | 0.7093 | d_model=256 |
| 10 | CMAR19 | 0.4209 | 0.9023 | 0.7140 | Cosine CMAR |
